...
class BaseClient(Generic[_HttpxClientT, _DefaultStreamT]):
    ...
    def _parse_retry_after_header(self, response_headers: Optional[httpx.Headers] = None) -> float | None:
        ...
        # Try the non-standard `retry-after-ms` header for milliseconds (more precise)
        ...
        # Try parsing `retry-after` header as seconds (allowing nonstandard floats)
        ...
        if retry_header is not None:
            ...
            # Try parsing `retry-after` as a date ONLY if it's not a valid float
